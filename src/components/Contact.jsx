...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    // Kita panggil variabel rahasia dari Vercel menggunakan import.meta.env
    emailjs
      .sendForm(
      ...
      .then(
        ...
        (error) => {
          console.error("Gagal kirim email:", error); // Saya tambah ini biar enak ngecek error di console
          setStatus('failed');
          setTimeout(() => setStatus(''), 5000);
        },
      );
  ...
  return (
    <div id="contact" className="bg-slate-900 text-white py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-12" data-aos="fade-up">Contact Me</h2>
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="md:w-1/2" data-aos="fade-right">
            ...
            <form ref={form} onSubmit={sendEmail}>
              <div className="mb-4">
                ...
                <input type="text" id="name" name="name" required className="w-full p-3 bg-slate-800 rounded-lg border border-slate-700 focus:outline-none focus:ring-2 focus:ring-purple-500" />
              </div>
              <div className="mb-4">
                <label htmlFor="email" className="block mb-2">Your Email</label>
                <input type="email" id="email" name="email" required className="w-full p-3 bg-slate-800 rounded-lg border border-slate-700 focus:outline-none focus:ring-2 focus:ring-purple-500" />
              </div>
              <div className="mb-4">
                <label htmlFor="message" className="block mb-2">Your Message</label>
                <textarea id="message" name="message" required rows="4" className="w-full p-3 bg-slate-800 rounded-lg border border-slate-700 focus:outline-none focus:ring-2 focus:ring-purple-500"></textarea>
              </div>
              <button type="submit" className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-lg w-full transition-colors duration-300" disabled={status === 'sending'}>
          ...
          {/* Bagian Kanan: Info Kontak & Sosial Media */}
          <div className="md:w-1/2" data-aos="fade-left">
            <h3 className="text-2xl font-semibold mb-4 text-purple-400">Connect With Me</h3>
            <p className="text-slate-400 mb-6">
              Got a question? Send me a message, and I'll get back to you soon. You can also find me on these platforms.
            </p>
            <div className="flex space-x-4">
              {/* Link LinkedIn */}
              <a href="https://www.linkedin.com/in/fakhri-aprianza/" target="_blank" rel="noopener noreferrer" className="bg-slate-800 p-3 rounded-full hover:bg-purple-600 transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd"/></svg>
              </a>
              {/* Link GitHub */}
              <a href="https://github.com/paripira" target="_blank" rel="noopener noreferrer" className="bg-slate-800 p-3 rounded-full hover:bg-purple-600 transition-colors">
              ...
              {/* Link Instagram */}
              <a href="https://www.instagram.com/anza.fkhri" target="_blank" rel="noopener noreferrer" className="bg-slate-800 p-3 rounded-full hover:bg-purple-600 transition-colors">
